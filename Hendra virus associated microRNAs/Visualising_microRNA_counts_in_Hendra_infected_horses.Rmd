...
I've used tidyverse to bring tabular data outputs from analysis into 'tidy' tables in which each variable forms a column, each observation forms a row and each cell holds a value. This can then feed into ggplot2 to make flexible visualizations. I have also used the RNA-seq packages, edgeR, limma and voom. All these were totally new to me! 
...
I've really enjoyed tidyverse, such a straightforward and standardized way of looking at data, particulary love the filter function!


# My time went ...

In the early weeks, learning to use a programming language was really hard. There was so many functions to remember and things moved very slowly. Once I could gather and spread and make plots of my data things moved much more quickly and it became addictive!
